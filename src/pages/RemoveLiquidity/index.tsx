...
import { ROUTER_ADDRESS, ETH } from "../../constants";
...
export default function RemoveLiquidity({
  ...
  const oneCurrencyIsWETH = Boolean(
    chainId &&
      ((currencyA && currencyEquals(ETH, currencyA)) ||
        (currencyB && currencyEquals(ETH, currencyB)))
  );
                    ...
                    {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                      <RowBetween style={{ justifyContent: "flex-end" }}>
                        {oneCurrencyIsETH ? (
                          <StyledInternalLink
                            to={`/remove/${
                              currencyA === ETHER ? ETH.address : currencyIdA
                            }/${
                              currencyB === ETHER ? ETH.address : currencyIdB
                            }`}
                          >
                            Receive WETH
                          </StyledInternalLink>
                          ...
                          <StyledInternalLink
                            to={`/remove/${
                              currencyA && currencyEquals(currencyA, ETH)
                                ? "ETH"
                                : currencyIdA
                            }/${
                              currencyB && currencyEquals(currencyB, ETH)
                                ? "ETH"
                                : currencyIdB
                            }`}
                          >
