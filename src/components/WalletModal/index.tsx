...
import { fortmatic, bsc, portis } from "../../connectors";
...
export default function WalletModal({
  ...
  function getOptions() {
    const isMetamask = window.BinanceChain && window.BinanceChain.isMetaMask;
    return Object.keys(SUPPORTED_WALLETS).map((key) => {
      ...
      if (isMobile) {
        ...
        if (!window.web3 && !window.BinanceChain && option.mobile) {
          return (
            <Option
              onClick={() => {
